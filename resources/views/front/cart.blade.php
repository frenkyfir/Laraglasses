                                        ...
                                        <div class="my-8 py-6 px-6 bg-white w-10/12 mx-auto">
                                            <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            <td class="text-left py-6">
                                                                <img src="../assets/img/product-1.jpg"
                                                                    class="w-full h-40" width="200"
                                                                    height="200">
                                                            </td>
                                                            <td class="text-center">{{ $cart->name }}</td>
                                                            <td class="text-center"> Jumlah Barang =
                                                                {{ $cart->quantity }}
                                                                <form method="POST"
                                                                    action="{{ route('update-cart') }}"
                                                                    ...
                                                                    <input type="number" id="quantity"
                                                                        ...
                                                                        class="rounded w-3/5 my-1">
                                                                    <button
                                                                        class="bg-cyan-900 w-3/5 py-2 text-dark rounded">Tambah
                                                                        Barang</button>
                                                                </form>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="bg-cyan-900 w-2/5 py-3 px-4 text-dark rounded-full"
                                                                    href="{{ route('remove-item', $cart->id) }}">HAPUS</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                ...
                                                <tfoot>
                                                    <tr class="">
                                                        <th colspan="4"
                                                            class="text-2xl font-base text-gray-500 text-left">
                                                            Total: <span>Rp.
                                                                {{ number_format(Cart::getTotal()) }}</span>
                                                        </th>
                                                        <td class="">
                                                            <a class="bg-cyan-900  py-3 px-2 text-dark rounded"
                                                                style="{{ Cart::isEmpty() ? 'pointer-events:none;' : '' }}"
                                                                href="{{ route('clear-item') }}">Clear Carts</a>
                                                        </td>
                                                    </tr>
                                                </tfoot>
